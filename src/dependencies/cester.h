...
#ifdef _MSC_VER
#pragma message(                                                               \
    "__BASE_FILE__ not defined. Define the __BASE_FILE__ directive in Properties -> C/C++ -> Preprocessor -> Preprocessor Definition as __BASE_FILE__=\"%(Filename)%(Extension)\" or register your test cases manually.")
#else
#pragma message(                                                               \
    "__BASE_FILE__ not defined. Define __BASE_FILE__ during compilation. -D__BASE_FILE__=\"/the/path/to/yout/testfile.c\" or register your test cases manually.")
#endif
#endif
...
**  Windows
**  Support Windows XP
**  To avoid error message : procedure entry point **
*InitializeConditionVariable could not be located **  in Kernel32.dll
*/
#ifdef _WIN32_WINNT
#undef _WIN32_WINNT
#endif
...
#define EXOTIC_API                                                             \
  __declspec(dllexport) /**< the platform is windows use windows export        \
                           keyword __declspec(dllexport) */
#else
#define EXOTIC_API                                                             \
  extern /**< Keyword to export the functions to allow ussage dynamically. NOT \
            USED. IGNORED  */
#endif
#else
#define EXOTIC_API
...
#define CESTER_BACKGROUND_GREEN                                                \
  39 /**< green terminal background color        */
#define CESTER_BACKGROUND_YELLOW                                               \
  96                              /**< yellow terminal background color       */
#define CESTER_BACKGROUND_BLUE 48 /**< blue terminal background color */
#define CESTER_BACKGROUND_MAGENTA                                              \
  87 /**< magenta terminal background color      */
#define CESTER_BACKGROUND_CYAN                                                 \
  176                            /**< cyan terminal background color         */
#define CESTER_BACKGROUND_GRAY 0 /**< gray terminal background color */
#define CESTER_BACKGROUND_WHITE                                                \
  10 /**< gray terminal background color         */
#define CESTER_RESET_TERMINAL_ATTR()                                           \
  SetConsoleTextAttribute(hConsole,                                            \
                          default_color); /**< reset the terminal color */

#else

#define CESTER_RESET_TERMINAL                                                  \
  "\x1B[0m"                   /**< reset the terminal color           */
#define CESTER_BOLD "\x1B[1m" /**< bold text                          */
#define CESTER_FOREGROUND_BLACK                                                \
  "\x1B[30m" /**< gray terminal foreground color     */
#define CESTER_FOREGROUND_RED                                                  \
  "\x1B[31m" /**< red terminal foreground color      */
#define CESTER_FOREGROUND_GREEN                                                \
  "\x1B[32m" /**< green foreground color             */
#define CESTER_FOREGROUND_YELLOW                                               \
  "\x1B[33m" /**< yellow terminal foreground color   */
#define CESTER_FOREGROUND_BLUE                                                 \
  "\x1B[34m" /**< blue terminal foreground color     */
#define CESTER_FOREGROUND_MAGENTA                                              \
  "\x1B[35m" /**< magenta terminal foreground color  */
#define CESTER_FOREGROUND_CYAN                                                 \
  "\x1B[36m" /**< cyan terminal foreground color     */
#define CESTER_FOREGROUND_WHITE                                                \
  "\x1B[37m" /**< white terminal foreground color    */
#define CESTER_FOREGROUND_GRAY                                                 \
  "\x1B[90m" /**< gray terminal foreground color     */
#define CESTER_BACKGROUND_BLACK                                                \
  "\x1B[40m" /**< black terminal background color    */
#define CESTER_BACKGROUND_RED                                                  \
  "\x1B[41m" /**< red terminal background color      */
#define CESTER_BACKGROUND_GREEN                                                \
  "\x1B[42m" /**< green terminal background color    */
#define CESTER_BACKGROUND_YELLOW                                               \
  "\x1B[43m" /**< yellow terminal background color   */
#define CESTER_BACKGROUND_BLUE                                                 \
  "\x1B[44m" /**< blue terminal background color     */
#define CESTER_BACKGROUND_MAGENTA                                              \
  "\x1B[45m" /**< magenta terminal background color  */
#define CESTER_BACKGROUND_CYAN                                                 \
  "\x1B[46m" /**< cyan terminal background color     */
#define CESTER_BACKGROUND_GRAY                                                 \
  "\x1B[100m" /**< gray terminal background color     */
#define CESTER_BACKGROUND_WHITE                                                \
  "\x1B[47m" /**< gray terminal background color     */
#define CESTER_RESET_TERMINAL_ATTR()                                           \
...
enum cester_test_status {
  ...
  CESTER_RESULT_FAILURE, /**< the test case failes dues to various reason mostly
                            AssertionError          */
  CESTER_RESULT_TERMINATED, /**< in isolated test, the test case was termiated
                               by a user or another program */
  CESTER_RESULT_SEGFAULT,   /**< the test case crahses or causes segmentation
                               fault                         */
#ifndef CESTER_NO_MEM_TEST
  CESTER_RESULT_MEMORY_LEAK, /**< the test case passes or fails but failed to
                                free allocated memory          */
#endif
  CESTER_RESULT_TIMED_OUT, /**< cester terminated the test case because it
                              running for too long            */
  CESTER_RESULT_UNKNOWN    /**< the test case was never ran    */
};

typedef enum cester_test_type {
  CESTER_NORMAL_TEST, /**< normal test in global or test suite. For internal use
                         only.                                              */
  CESTER_NORMAL_TODO_TEST, /**< test to be implemented in future. For internal
                              use only. */
  CESTER_NORMAL_SKIP_TEST, /**< test to be skipped. For internal use only. */
  CESTER_BEFORE_ALL_TEST,  /**< test to run before all normal tests in global or
                              test suite. For internal use only.  */
  CESTER_BEFORE_EACH_TEST, /**< test to run before each normal tests in global
                              or test suite. For internal use only. */
  CESTER_AFTER_ALL_TEST,   /**< test to run after all normal tests in global or
                              test suite. For internal use only.   */
  CESTER_AFTER_EACH_TEST,  /**< test to run after each normal tests in global or
                              test suite. For internal use only.  */
  CESTER_OPTIONS_FUNCTION, /**< the cester function for test, this wil be
                              excuted before running the tests. For internal use
                              only.       */
  CESTER_TEST_FILE_COMMENT, /**< The function that holds the text defined in the
                               CESTER_COMMENT macro. For internal use only. */
  CESTER_TESTS_TERMINATOR   /**< the last value in the test cases to terminates
                               the tests. For internal use only.   */
} TestType;
...
typedef struct test_case {
  unsigned execution_status; /**< the test execution result status. For internal
                                use only. */
  unsigned line_num; /**< the line number where the test case is created. For
                        internal use only. */
  enum cester_test_status expected_result; /**< The expected result for the test
                                              case. For internal use only. */
#ifndef CESTER_NO_TIME
  double start_tic;      /**< the time taken for the test case to complete. For
                            internal use only. */
  double execution_time; /**< the time taken for the test case to complete. For
                            internal use only. */
#endif
  char *execution_output; /**< the test execution output in string. For internal
                             use only. */
  char *name;             /**< the test function name. For internal use only. */
  cester_test test_function; /**< the function that enclosed the tests. For
                                internal use only. */
  cester_before_after_each test_ba_function; /**< the function that enclosed the
                                                tests. For internal use only. */
  cester_void test_void_function; /**< the function that enclosed the tests. For
                                     internal use only. */
  TestType
      test_type; /**< the type of the test function. For internal use only. */
} TestCase;

#ifndef CESTER_NO_MEM_TEST

typedef struct allocated_memory {
  unsigned line_num; /**< the line number where the memory was allocated. For
                        internal use only.   */
  unsigned allocated_bytes; /**< the number of allocated bytes. For internal use
                               only.                    */
  char *address; /**< the allocated pointer address. For internal use only. */
  const char *function_name; /**< the function where the memory is allocated in.
                                For internal use only.    */
  const char *file_name; /**< the file name where the memory is allocated. For
                            internal use only.      */
} AllocatedMemory;
...
typedef struct cester_array_struct {
  ...
  size_t capacity; /**< the number of item the array can contain before
                      expanding */
...
typedef struct super_test_instance {
  unsigned no_color; /**< Do not print to the console with color if one. For
                        internal use only. */
  unsigned total_tests_count; /**< the total number of tests to run, assert,
                                 eval e.t.c. To use in your code call
                                 CESTER_TOTAL_TESTS_COUNT */
  unsigned
      total_tests_ran; /**< the total number of tests that was run e.t.c. To use
                          in your code call CESTER_TOTAL_TESTS_RAN */
  unsigned total_failed_tests_count; /**< the total number of tests that failed.
                                        To use in your code call
                                        CESTER_TOTAL_FAILED_TESTS_COUNT */
  unsigned total_passed_tests_count; /**< the total number of tests that passed.
                                        To use in your code call
                                        CESTER_TOTAL_FAILED_TESTS_COUNT */
  unsigned total_test_errors_count; /**< the total number of errors that occurs.
                                       To use in your code call
                                       CESTER_TOTAL_TEST_ERRORS_COUNT */
  unsigned
      verbose; /**< prints as much info as possible into the output stream */
  ...
  unsigned
      selected_test_cases_size; /**< the number of selected test casses from
                                   command line. For internal use only. */
  unsigned selected_test_cases_found; /**< the number of selected test casses
                                         from command line that is found in the
                                         test file. For internal use only. */
  unsigned
      single_output_only;   /**< display the output for a single test only no
                               summary and syntesis. For internal use only. */
  unsigned mem_test_active; /**< Enable or disable memory test at runtime.
                               Enabled by default. For internal use only. */
  unsigned current_execution_status; /**< the current test case status. This is
                                        used when the test cases run on a single
                                        process. For internal use only. */
  unsigned isolate_tests;      /**< Isolate each test case to run in different
                                  process to prevent a crashing test case from
                                  crahsing others. For internal use only. */
  unsigned skipped_test_count; /**< The number of test cases to be skipped. For
                                  internal use only. */
  unsigned todo_tests_count;   /**< The number of test cases that would be
                                  implemented in future. For internal use only. */
  unsigned format_test_name;   /**< Format the test name for fine output e.g.
                                  'test_file_exit' becomes 'test file exist'. For
                                  internal use only. */
  unsigned report_success_regardless;    /**< If the value is set to 1 the test
                                            will be mark as success even if it
                                            fails. For internal use only. */
  unsigned report_failure_regardless;    /**< If the value is set to 1 the test
                                            will be mark as failure even if it
                                            passes. For internal use only. */
  TestType current_cester_function_type; /**< The current cester funtion type,
                                            this enable cester to properly track
                                            memory allocation in non test case
                                            functions. For internal use only. */
#ifndef CESTER_NO_TIME
  double start_tic; /**< The unix time when the tests starts. For internal use
                       only. */
#endif
  char *main_execution_output; /**< The main test execution output in string.
                                  For internal use only. . */
  char *flattened_cmd_argv;    /**< Flattened command line argument for sub
                                  process. For internal use only. */
  char *test_file_path; /**< The main test file full path. For internal use
                           only. */
  char *output_format;  /**< The output format to print the test result in. For
                           internal use only. */
  TestInstance *test_instance; /**< The test instance for sharing datas. For
                                  internal use only. */
  FILE *output_stream;         /**< Output stream to write message to, stdout by
                                  default. For internal use only. */
  char **selected_test_cases_names; /**< selected test cases from command line.
                                       For internal use only. e.g.
                                       --cester-test=Test2,Test1 */
  TestCase *current_test_case;      /**< The currently running test case. For
                                       internal use only. */
  CesterArray
      *registered_test_cases; /**< all the manually registered test cases in the
                                 instance. For internal use only. */
#ifndef CESTER_NO_MEM_TEST
  CesterArray
      *mem_alloc_manager; /**< the array of allocated memory. For testing and
                             detecting memory leaks. For internal use only. */
#endif
} SuperTestInstance;
...
static __CESTER_INLINE__ void cester_str_value_after_first(char *, char,
                                                           char **);

SuperTestInstance superTestInstance = {0,
                                       0,
                                       0,
                                       0,
                                       0,
...
/**
    Change the output stream used by cester to write data. The default is
`stdout`. E.g to change the output stream to a file.
...
/**
    ...
    This option can also be set from the command line with
`--cester-printversion`
**/
...
*/
#define CESTER_OUTPUT_JUNITXML()                                               \
  superTestInstance.output_format = (char *)"junitxml";
...
*/
#define CESTER_OUTPUT_TAPV13()                                                 \
  superTestInstance.output_format = (char *)"tapV13";
...
/**
    The total number of tests that passed. CESTER_TOTAL_TESTS_COUNT -
   CESTER_TOTAL_FAILED_TESTS_COUNT
*/
...
*/
#define CESTER_REPORT_SUCCESS_REGARDLESS()                                     \
  (superTestInstance.report_failure_regardless = 0);                           \
  (superTestInstance.report_success_regardless = 1)

/**
    Always mark the test as failure even if the test cases
    passes and no error occur.
*/
#define CESTER_REPORT_FAILURE_REGARDLESS()                                     \
  (superTestInstance.report_success_regardless = 0);                           \
  (superTestInstance.report_failure_regardless = 1)
...
static __CESTER_INLINE__ char *
cester_extract_name(char const *const file_path) {
  unsigned i = 0, j = 0;
...
static __CESTER_INLINE__ char *
cester_extract_name_only(char const *const file_path) {
  unsigned i = 0;
...
static __CESTER_INLINE__ unsigned cester_str_after_prefix(const char *arg,
                                                          char *prefix,
...
static __CESTER_INLINE__ char *cester_str_replace(char *str, char old_char,
                                                  char new_char) {
...
static __CESTER_INLINE__ unsigned cester_string_starts_with(char *arg,
                                                            char *arg1) {
  unsigned i = 0;
  while (1) {
    if (arg[i] == '\0' && arg1[i] == '\0') {
...
static __CESTER_INLINE__ void unpack_selected_extra_args(char *arg, char ***out,
                                                         unsigned *out_size) {
  unsigned i = 0;
...
static __CESTER_INLINE__ void cester_str_value_after_first(char *arg, char from,
                                                           char **out) {
...
static __CESTER_INLINE__ unsigned
cester_is_validate_output_option(char *format_option) {
...
#ifdef _WIN32
#define CESTER_SELECTCOLOR(x)                                                  \
  (superTestInstance.no_color == 1 ? default_color : x)
#else
#define CESTER_SELECTCOLOR(x) (superTestInstance.no_color == 1 ? "" : x)
#endif
#define CESTER_GET_RESULT_AGGR                                                 \
  (superTestInstance.total_failed_tests_count == 0 ? "SUCCESS" : "FAILURE")
#define CESTER_GET_RESULT_AGGR_COLOR                                           \
  (superTestInstance.total_failed_tests_count == 0 ? (CESTER_FOREGROUND_GREEN) \
                                                   : (CESTER_FOREGROUND_RED))

#ifdef _WIN32
#define CESTER_DELEGATE_FPRINT_STR(x, y)                                       \
  SetConsoleTextAttribute(hConsole, CESTER_SELECTCOLOR(x));                    \
  fprintf(superTestInstance.output_stream, "%s", y)
#define CESTER_DELEGATE_FPRINT_INT(x, y)                                       \
  SetConsoleTextAttribute(hConsole, CESTER_SELECTCOLOR(x));                    \
  fprintf(superTestInstance.output_stream, "%d", y)
#define CESTER_DELEGATE_FPRINT_UINT(x, y)                                      \
  SetConsoleTextAttribute(hConsole, CESTER_SELECTCOLOR(x));                    \
  fprintf(superTestInstance.output_stream, "%u", y)
#ifndef CESTER_NO_TIME
#define CESTER_DELEGATE_FPRINT_DOUBLE(x, y)                                    \
  SetConsoleTextAttribute(hConsole, CESTER_SELECTCOLOR(x));                    \
  fprintf(superTestInstance.output_stream, "%f", y)
#define CESTER_DELEGATE_FPRINT_DOUBLE_2(x, y)                                  \
  SetConsoleTextAttribute(hConsole, CESTER_SELECTCOLOR(x));                    \
  fprintf(superTestInstance.output_stream, "%.2f", y)
#endif
#else
#define CESTER_DELEGATE_FPRINT_STR(x, y)                                       \
  fprintf(superTestInstance.output_stream, "%s%s%s", CESTER_SELECTCOLOR(x), y, \
          CESTER_SELECTCOLOR(CESTER_RESET_TERMINAL))
#define CESTER_DELEGATE_FPRINT_INT(x, y)                                       \
  fprintf(superTestInstance.output_stream, "%s%d%s", CESTER_SELECTCOLOR(x), y, \
          CESTER_SELECTCOLOR(CESTER_RESET_TERMINAL))
#define CESTER_DELEGATE_FPRINT_UINT(x, y)                                      \
  fprintf(superTestInstance.output_stream, "%s%u%s", CESTER_SELECTCOLOR(x), y, \
          CESTER_SELECTCOLOR(CESTER_RESET_TERMINAL))
#ifndef CESTER_NO_TIME
#define CESTER_DELEGATE_FPRINT_DOUBLE(x, y)                                    \
  fprintf(superTestInstance.output_stream, "%s%f%s", CESTER_SELECTCOLOR(x), y, \
          CESTER_SELECTCOLOR(CESTER_RESET_TERMINAL))
#define CESTER_DELEGATE_FPRINT_DOUBLE_2(x, y)                                  \
  fprintf(superTestInstance.output_stream, "%s%.2f%s", CESTER_SELECTCOLOR(x),  \
          y, CESTER_SELECTCOLOR(CESTER_RESET_TERMINAL))
#endif
#endif
...
static __CESTER_INLINE__ void cester_print_help() {
  ...
  CESTER_DELEGATE_FPRINT_STR(
      ...
      cester_extract_name_only(superTestInstance.test_file_path));
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             " [-options] [args...]\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "\nwhere options include:\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-minimal         print minimal info "
                             "into the output stream\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-verbose         print as much info "
                             "as possible into the output stream\n");
  CESTER_DELEGATE_FPRINT_STR(
      (CESTER_FOREGROUND_WHITE),
...
#ifndef CESTER_NO_MEM_TEST
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-nomemtest       disable memory leak "
                             "detection in the tests\n");
#endif
#ifdef __CESTER_STDC_VERSION__
  CESTER_DELEGATE_FPRINT_STR(
      (CESTER_FOREGROUND_WHITE),
      "    --cester-noisolation     run all the test on a single process. "
      "Prevents recovery from crash.\n");
#endif
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-printversion    display cester "
                             "version before running the tests\n");
  CESTER_DELEGATE_FPRINT_STR(
      (CESTER_FOREGROUND_WHITE),
      "    --cester-dontformatname  leave the test case name as declared in "
      "the source file in the output\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-test=Test1,...  run only selected "
                             "tests. Seperate the test cases by comma\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
                             "    --cester-output=[FORMAT] change the format "
                             "in which the test results are printed\n");
  CESTER_DELEGATE_FPRINT_STR(
      (CESTER_FOREGROUND_WHITE),
  ...
  CESTER_DELEGATE_FPRINT_STR(
      (CESTER_FOREGROUND_WHITE),
      "See https://exoticlibraries.github.io/libcester/docs/options.html for "
      "more details\n");
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
...
static __CESTER_INLINE__ void
cester_print_assertion(char const *const expression,
                       char const *const file_path, unsigned const line_num) {
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    (superTestInstance.minimal == 0
                         ? file_path
                         : cester_extract_name(file_path)));
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    ":");
  cester_concat_int(&(superTestInstance.current_test_case)->execution_output,
                    line_num);
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    ":");
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    " in '");
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    (superTestInstance.current_test_case)->name);
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    "' expr => '");
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    expression);
  ...
  /*CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
  (superTestInstance.verbose == 1 ? file_path : cester_extract_name(file_path)
  )); CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), ":");
...
static __CESTER_INLINE__ void cester_print_expect_actual(
    unsigned expecting, char const *const expect, char const *const received,
    char const *const file_path, unsigned const line_num) {
  cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                    (superTestInstance.minimal == 0
                         ? file_path
...
static __CESTER_INLINE__ void print_test_result() {
#endif
  unsigned cached_total_failed_tests_count =
      superTestInstance.total_failed_tests_count;
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), "\nRan ");
  CESTER_DELEGATE_FPRINT_INT((CESTER_FOREGROUND_WHITE),
  ...
  CESTER_DELEGATE_FPRINT_DOUBLE_2(
      (CESTER_FOREGROUND_WHITE),
      (time_spent > 60 ? (time_spent / 60) : time_spent));
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE),
  ...
  superTestInstance.total_failed_tests_count =
      superTestInstance.current_execution_status == CESTER_RESULT_SUCCESS &&
              superTestInstance.total_failed_tests_count == 0
          ? 0
          : 1;
  ...
  if (superTestInstance.report_success_regardless == 1) {
    ...
    CESTER_DELEGATE_FPRINT_STR(CESTER_GET_RESULT_AGGR_COLOR,
  ...
  CESTER_DELEGATE_FPRINT_INT((CESTER_FOREGROUND_GREEN),
                             CESTER_TOTAL_PASSED_TESTS_COUNT);
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), " | Failing: ");
  CESTER_DELEGATE_FPRINT_INT((CESTER_FOREGROUND_RED),
                             CESTER_TOTAL_FAILED_TESTS_COUNT);
  ...
  CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), "\n");
  if (superTestInstance.report_failure_regardless == 1 ||
      superTestInstance.report_success_regardless == 1) {
    CESTER_DELEGATE_FPRINT_STR(
        (CESTER_FOREGROUND_YELLOW),
        "Avoid using the CESTER_REPORT_*_REGARDLESS macros, they hides the "
...
static __CESTER_INLINE__ void print_test_case_result(TestCase *test_case) {
  ...
  if (test_case->test_type == CESTER_NORMAL_TODO_TEST ||
      test_case->test_type == CESTER_NORMAL_SKIP_TEST) {
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW), "o ");
#ifndef CESTER_NO_TIME
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), "(");
    CESTER_DELEGATE_FPRINT_DOUBLE_2((CESTER_FOREGROUND_GRAY),
                                    (test_case->execution_time > 60
                                         ? (test_case->execution_time / 60)
                                         : test_case->execution_time));
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY),
                               (test_case->execution_time > 60 ? "m" : "s"));
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), ") ");
#endif
    CESTER_DELEGATE_FPRINT_STR(
        (CESTER_FOREGROUND_GRAY),
        (superTestInstance.format_test_name == 1
             ? cester_str_replace(test_case->name, '_', ' ')
             : test_case->name));
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                               (test_case->test_type == CESTER_NORMAL_TODO_TEST
                                    ? " TODO "
                                    : " SKIP "));
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), "\n");
  } else {
    ...
    CESTER_DELEGATE_FPRINT_DOUBLE_2((print_color),
                                    (test_case->execution_time > 60
                                         ? (test_case->execution_time / 60)
                                         : test_case->execution_time));
    CESTER_DELEGATE_FPRINT_STR((print_color),
...
#endif
    CESTER_DELEGATE_FPRINT_STR(
        (print_color), (superTestInstance.format_test_name == 1
                            ? cester_str_replace(test_case->name, '_', ' ')
                            : test_case->name));
    CESTER_DELEGATE_FPRINT_STR((print_color), "\n");
  }
...
static __CESTER_INLINE__ void print_test_case_outputs(TestCase *test_case) {
  if (test_case->execution_status == CESTER_RESULT_SEGFAULT ||
      test_case->execution_status == CESTER_RESULT_TERMINATED) {
    if (test_case->execution_status == CESTER_RESULT_SEGFAULT) {
    ...
    CESTER_DELEGATE_FPRINT_STR(
        (CESTER_FOREGROUND_WHITE),
        (superTestInstance.minimal == 0
             ? superTestInstance.test_file_path
             : cester_extract_name(superTestInstance.test_file_path)));
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_WHITE), ":");
...
static __CESTER_INLINE__ void write_testcase_tap(TestCase *a_test_case,
  ...
  CESTER_DELEGATE_FPRINT_STR(
      (print_color), (superTestInstance.format_test_name == 1
                          ? cester_str_replace(a_test_case->name, '_', ' ')
                          : a_test_case->name));
  CESTER_DELEGATE_FPRINT_STR((print_color), ", ");
  ...
  if (superTestInstance.verbose == 1) {
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY),
                               a_test_case->execution_output);
  }
}

static __CESTER_INLINE__ void
write_testcase_tap_v13(TestCase *a_test_case, char *file_name, int index) {
#ifdef _WIN32
  unsigned print_color = __CESTER_CAST_CHAR_ARRAY__ CESTER_FOREGROUND_YELLOW;
#else
  char *print_color = __CESTER_CAST_CHAR_ARRAY__ CESTER_FOREGROUND_YELLOW;
  ...
  if (superTestInstance.verbose == 1 &&
    ...
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), "\n  time: ");
    CESTER_DELEGATE_FPRINT_DOUBLE_2((CESTER_FOREGROUND_GRAY),
                                    a_test_case->execution_time);
#endif
    CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), "\n  ...\n");
  }
}

static __CESTER_INLINE__ void write_testcase_junitxml(TestCase *a_test_case,
                                                      char *file_name) {
  ...
  case CESTER_RESULT_TERMINATED:
    if (a_test_case->execution_status == CESTER_RESULT_SEGFAULT) {
      CESTER_DELEGATE_FPRINT_STR((default_color),
                                 ">\n        <failure message=\"the test case "
                                 "crashed\" type=\"SegmentationFault\">");
      CESTER_DELEGATE_FPRINT_STR((default_color), "SegfaultError ");
    } else {
      CESTER_DELEGATE_FPRINT_STR(
          (default_color), ">\n        <failure message=\"the test case was "
                           "terminated\" type=\"PrematureTermination\">");
  ...
  case CESTER_RESULT_MEMORY_LEAK:
    CESTER_DELEGATE_FPRINT_STR((default_color),
                               ">\n        <failure message=\"the test case "
                               "leaks memory\" type=\"MemoryLeakError\">");
    CESTER_DELEGATE_FPRINT_STR((default_color), a_test_case->execution_output);
    CESTER_DELEGATE_FPRINT_STR((default_color),
                               "        </failure>\n    </testcase>\n");
    break;
...
static __CESTER_INLINE__ unsigned
check_memory_allocated_for_functions(char *funcname1, char *funcname2,
                                     char *prefix, char **write_string) {
#ifndef CESTER_NO_MEM_TEST
  unsigned mem_index;
  unsigned leaked_memory_count = 0;
  if (superTestInstance.mem_test_active == 1) {
    CESTER_ARRAY_FOREACH(
        superTestInstance.mem_alloc_manager, mem_index, alloc_mem, {
          if ((funcname1 != NULL &&
               cester_string_equals(
                   (char *)((AllocatedMemory *)alloc_mem)->function_name,
                   funcname1)) ||
              (funcname2 != NULL &&
               cester_string_equals(
                   (char *)((AllocatedMemory *)alloc_mem)->function_name,
            ...
            if (superTestInstance.current_test_case != NULL) {
              ...
              cester_concat_str(write_string,
                                (superTestInstance.minimal == 0
                                     ...
                                     : cester_extract_name(
                                           superTestInstance.test_file_path)));
              cester_concat_str(write_string, ":");
              cester_concat_int(write_string,
                                ((AllocatedMemory *)alloc_mem)->line_num);
              cester_concat_str(write_string, ": ");
              ...
              cester_concat_int(
                  write_string,
                  ((AllocatedMemory *)alloc_mem)->allocated_bytes);
...
static __CESTER_INLINE__ int cester_print_result(TestCase cester_test_cases[],
  ...
  if (superTestInstance.registered_test_cases->size == 0) {
    for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
         ++i) {
  ...
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index4, test_case, {
        if (((TestCase *)test_case)->test_type == CESTER_AFTER_ALL_TEST &&
            superTestInstance.single_output_only == 0) {
          superTestInstance.current_cester_function_type =
              CESTER_AFTER_ALL_TEST;
          ((cester_test)((TestCase *)test_case)->test_function)(test_instance);
        }
      })
  if (cester_string_equals(superTestInstance.output_format, (char *)"tap") ==
          1 ||
      cester_string_equals(superTestInstance.output_format, (char *)"tapV13") ==
          1) {
    prefix = "# ";
  }
  ret_val = check_memory_allocated_for_functions(
      (char *)"CESTER_BEFORE_ALL", (char *)"CESTER_OPTIONS", prefix,
      &superTestInstance.main_execution_output);
  if (ret_val > 0) {
  ...
  if (superTestInstance.single_output_only == 0) {
    if (cester_string_equals(superTestInstance.output_format,
                             (char *)"junitxml") == 1) {
      CESTER_DELEGATE_FPRINT_STR(
          (default_color), "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n");
      CESTER_DELEGATE_FPRINT_STR((default_color), "<testsuite tests=\"");
      CESTER_DELEGATE_FPRINT_INT(
          (default_color), (superTestInstance.selected_test_cases_size == 0
                                ? CESTER_TOTAL_TESTS_COUNT
                                : CESTER_TOTAL_TESTS_RAN));
      CESTER_DELEGATE_FPRINT_STR((default_color), "\" failures=\"");
      CESTER_DELEGATE_FPRINT_INT((default_color),
                                 superTestInstance.total_failed_tests_count);
      CESTER_DELEGATE_FPRINT_STR((default_color), "\" name=\"");
      CESTER_DELEGATE_FPRINT_STR(
          (default_color),
      ...
      CESTER_ARRAY_FOREACH(
          superTestInstance.registered_test_cases, index5, test_case, {
            if (((TestCase *)test_case)->test_type == CESTER_NORMAL_TEST &&
                ((TestCase *)test_case)->execution_status !=
    ...
    } else if (cester_string_equals(superTestInstance.output_format,
                                    (char *)"tap") == 1) {
        ...
        for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
          ...
          if ((cester_test_cases[i].test_type == CESTER_NORMAL_TEST ||
            ...
            if (superTestInstance.selected_test_cases_size > 0 &&
                cester_test_cases[i].execution_status ==
                    CESTER_RESULT_UNKNOWN) {
              continue;
            }
            write_testcase_tap(
      ...
      if (superTestInstance.verbose == 1) {
        if (CESTER_TOTAL_TEST_ERRORS_COUNT > 0) {
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), "# ");
          CESTER_DELEGATE_FPRINT_INT((CESTER_FOREGROUND_GRAY),
                                     CESTER_TOTAL_TEST_ERRORS_COUNT);
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY),
                                     " total error(s) occured\n");
        }
        if (CESTER_TOTAL_TODO_TESTS > 0) {
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_GRAY), "# ");
          CESTER_DELEGATE_FPRINT_INT((CESTER_FOREGROUND_GRAY),
      ...
      CESTER_ARRAY_FOREACH(
          superTestInstance.registered_test_cases, index6, test_case_delegate, {
            ...
            } else if (((test_case->test_type == CESTER_NORMAL_TEST &&
      ...
      CESTER_ARRAY_FOREACH(
          superTestInstance.registered_test_cases, index7, test_case_delegate1,
          {
            TestCase *test_case1 = (TestCase *)test_case_delegate1;
            if (test_case1->test_type == CESTER_NORMAL_TEST &&
                test_case1->execution_status != CESTER_RESULT_UNKNOWN) {
...
*/
#define cester_assert_cmp(x, y, z)                                             \
...
*/
#define cester_assert_not_null(x)                                              \
  cester_assert_cmp_msg(x, !=, NULL, "!(" #x ")")
...
*/
#define cester_assert_equal(x, y)                                              \
...
/**
    ...
    \param y the second expression to compare to the first expression
*/
#define cester_assert_not_equal(x, y)                                          \
...
*/
#define cester_assert_str_equal(x, y)                                          \
  cester_evaluate_expect_actual_str(x, y, 1, __FILE__, __LINE__)
...
/**
    ...
    \param y another string to compare with the first string
*/
#define cester_assert_str_not_equal(x, y)                                      \
  cester_evaluate_expect_actual_str(x, y, 0, __FILE__, __LINE__)
...
*/
#define cester_assert_ptr_equal(x, y)                                          \
  cester_evaluate_expect_actual_ptr(x, y, 1, __FILE__, __LINE__)
...
/**
    ...
    \param y another pointer to compare with the first pointer
*/
#define cester_assert_ptr_not_equal(x, y)                                      \
  cester_evaluate_expect_actual_ptr(x, y, 0, __FILE__, __LINE__)

/* document the following, add 'compile time only' */
#define __internal_cester_assert_cmp(w, x, y, z)                               \
  (w x y, z, w, y, #x, __FILE__, __LINE__)
#define __internal_cester_assert_eq(x, y, z)                                   \
  (x == y, "expected " #z ",%s received " #z, y, x, "", __FILE__, __LINE__)
#define __internal_cester_assert_ne(x, y, z)                                   \
  (x != y, "not expecting " #z ",%s found " #z, x, y, "", __FILE__, __LINE__)
#define __internal_cester_assert_gt(x, y, z)                                   \
  (x > y, "expected value to be greater than " #z ",%s received " #z, x, y,    \
   "", __FILE__, __LINE__)
#define __internal_cester_assert_ge(x, y, z)                                   \
  (x >= y,                                                                     \
   "expected value to be greater than or equal to " #z ",%s received " #z, x,  \
   y, "", __FILE__, __LINE__)
#define __internal_cester_assert_lt(x, y, z)                                   \
  (x < y, "expected value to be lesser than " #z ",%s received " #z, x, y, "", \
   __FILE__, __LINE__)
#define __internal_cester_assert_le(x, y, z)                                   \
  (x <= y,                                                                     \
   "expected value to be lesser than or equal to " #z ",%s received " #z, x,   \
   y, "", __FILE__, __LINE__)
...
*/
#define cester_assert_cmp_char(w, x, y, z)                                     \
  CESTER_CONCAT(cester_compare_char, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_eq(x, y)                                            \
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_ne(x, y)                                            \
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_gt(x, y)                                            \
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_ge(x, y)                                            \
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_lt(x, y)                                            \
...
/**
    ...
    \param y another char
*/
#define cester_assert_char_le(x, y)                                            \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_uchar(w, x, y, z)                                    \
  CESTER_CONCAT(cester_compare_uchar, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_eq(x, y)                                           \
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_ne(x, y)                                           \
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_gt(x, y)                                           \
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_ge(x, y)                                           \
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_lt(x, y)                                           \
...
/**
    ...
    \param y another unsigned char
*/
#define cester_assert_uchar_le(x, y)                                           \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_short(w, x, y, z)                                    \
  CESTER_CONCAT(cester_compare_short, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_eq(x, y)                                           \
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_ne(x, y)                                           \
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_gt(x, y)                                           \
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_ge(x, y)                                           \
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_lt(x, y)                                           \
...
/**
    ...
    \param y another short
*/
#define cester_assert_short_le(x, y)                                           \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_ushort(w, x, y, z)                                   \
  CESTER_CONCAT(cester_compare_ushort, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_eq(x, y)                                          \
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_ne(x, y)                                          \
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_gt(x, y)                                          \
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_ge(x, y)                                          \
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_lt(x, y)                                          \
...
/**
    ...
    \param y another unsigned short
*/
#define cester_assert_ushort_le(x, y)                                          \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_int(w, x, y, z)                                      \
  CESTER_CONCAT(cester_compare_int, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_eq(x, y)                                             \
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_ne(x, y)                                             \
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_gt(x, y)                                             \
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_ge(x, y)                                             \
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_lt(x, y)                                             \
...
/**
    ...
    \param y another int
*/
#define cester_assert_int_le(x, y)                                             \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_uint(w, x, y, z)                                     \
  CESTER_CONCAT(cester_compare_uint, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_eq(x, y)                                            \
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_ne(x, y)                                            \
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_gt(x, y)                                            \
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_ge(x, y)                                            \
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_lt(x, y)                                            \
...
/**
    ...
    \param y another unsigned int
*/
#define cester_assert_uint_le(x, y)                                            \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_long(w, x, y, z)                                     \
  CESTER_CONCAT(cester_compare_long, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_eq(x, y)                                            \
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_ne(x, y)                                            \
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_gt(x, y)                                            \
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_ge(x, y)                                            \
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_lt(x, y)                                            \
...
/**
    ...
    \param y another long
*/
#define cester_assert_long_le(x, y)                                            \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_ulong(w, x, y, z)                                    \
  CESTER_CONCAT(cester_compare_ulong, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_eq(x, y)                                           \
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_ne(x, y)                                           \
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_gt(x, y)                                           \
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_ge(x, y)                                           \
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_lt(x, y)                                           \
...
/**
    ...
    \param y another unsigned long
*/
#define cester_assert_ulong_le(x, y)                                           \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_llong(w, x, y, z)                                    \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_cmp(w, x, y, z))
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_eq(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_eq(x, y, % li))
#else
#define cester_assert_llong_eq(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_eq(x, y, % lli))
#endif
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_ne(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ne(x, y, % li))
#else
#define cester_assert_llong_ne(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ne(x, y, % lli))
#endif
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_gt(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_gt(x, y, % li))
#else
#define cester_assert_llong_gt(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_gt(x, y, % lli))
#endif
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_ge(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ge(x, y, % li))
#else
#define cester_assert_llong_ge(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ge(x, y, % lli))
#endif
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_lt(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_lt(x, y, % li))
#else
#define cester_assert_llong_lt(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_lt(x, y, % lli))
#endif
...
*/
#ifndef __CESTER_STDC_VERSION__
#define cester_assert_llong_le(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ge(x, y, % li))
#else
#define cester_assert_llong_le(x, y)                                           \
  CESTER_CONCAT(cester_compare_llong, __internal_cester_assert_ge(x, y, % lli))
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_ullong(w, x, y, z)                                   \
  CESTER_CONCAT(cester_compare_ullong, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_eq(x, y)                                          \
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_ne(x, y)                                          \
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_gt(x, y)                                          \
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_ge(x, y)                                          \
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_lt(x, y)                                          \
...
/**
    ...
    \param y another unsigned long long
*/
#define cester_assert_ullong_le(x, y)                                          \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_float(w, x, y, z)                                    \
  CESTER_CONCAT(cester_compare_float, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_eq(x, y)                                           \
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_ne(x, y)                                           \
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_gt(x, y)                                           \
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_ge(x, y)                                           \
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_lt(x, y)                                           \
...
/**
    ...
    \param y another float
*/
#define cester_assert_float_le(x, y)                                           \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_double(w, x, y, z)                                   \
  CESTER_CONCAT(cester_compare_double, __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_eq(x, y)                                          \
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_ne(x, y)                                          \
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_gt(x, y)                                          \
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_ge(x, y)                                          \
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_lt(x, y)                                          \
...
/**
    ...
    \param y another double
*/
#define cester_assert_double_le(x, y)                                          \
...
/**
    ...
    \param z the string formated for output
*/
#define cester_assert_cmp_ldouble(w, x, y, z)                                  \
  CESTER_CONCAT(cester_compare_ldouble,                                        \
                __internal_cester_assert_cmp(w, x, y, z))
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_eq(x, y)                                         \
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_ne(x, y)                                         \
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_gt(x, y)                                         \
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_ge(x, y)                                         \
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_lt(x, y)                                         \
...
/**
    ...
    \param y another long double
*/
#define cester_assert_ldouble_le(x, y)                                         \
  CESTER_CONCAT(cester_compare_ldouble, __internal_cester_assert_le(x, y, % e))

static __CESTER_INLINE__ void
cester_evaluate_expression(unsigned eval_result, char const *const expression,
...
static __CESTER_INLINE__ void cester_evaluate_expect_actual(
    unsigned eval_result, unsigned expecting, char const *const expected,
    char const *const actual, char const *const file_path,
    unsigned const line_num) {
  ...
  if (eval_result == 0 || superTestInstance.verbose == 1) {
    cester_print_expect_actual(expecting, expected, actual, file_path,
                               line_num);
    cester_concat_str(&(superTestInstance.current_test_case)->execution_output,
                      "\n");
  }
...
static __CESTER_INLINE__ void cester_evaluate_expect_actual_str(
    char const *const expected, char const *const actual, unsigned expecting,
    char const *const file_path, unsigned const line_num) {
...
static __CESTER_INLINE__ void
cester_evaluate_expect_actual_ptr(void *ptr1, void *ptr2, unsigned expecting,
                                  char const *const file_path,
                                  unsigned const line_num) {
...
static __CESTER_INLINE__ void
cester_compare_char(int eval_result, char const *const expr, char first,
                    char second, char const *const op,
                    char const *const file_path, unsigned const line_num) {
  char expression[2048] = "";
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
                             line_num);
}

static __CESTER_INLINE__ void
cester_compare_uchar(int eval_result, char const *const expr,
                     unsigned char first, unsigned char second,
                     char const *const op, char const *const file_path,
                     unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_int(int eval_result, char const *const expr, int first,
                   int second, char const *const op,
                   char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_uint(int eval_result, char const *const expr, unsigned int first,
                    unsigned int second, char const *const op,
                    char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_short(int eval_result, char const *const expr, short first,
                     short second, char const *const op,
                     char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_ushort(int eval_result, char const *const expr,
...
static __CESTER_INLINE__ void
cester_compare_long(int eval_result, char const *const expr, long first,
                    long second, char const *const op,
                    char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_ulong(int eval_result, char const *const expr,
...
static __CESTER_INLINE__ void
cester_compare_llong(int eval_result, char const *const expr,
                     __CESTER_LONG_LONG__ first, __CESTER_LONG_LONG__ second,
                     char const *const op, char const *const file_path,
                     unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
...
static __CESTER_INLINE__ void
cester_compare_ullong(int eval_result, char const *const expr,
                      unsigned __CESTER_LONG_LONG__ first,
                      unsigned __CESTER_LONG_LONG__ second,
                      char const *const op, char const *const file_path,
                      unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
...
static __CESTER_INLINE__ void
cester_compare_float(int eval_result, char const *const expr, float first,
                     float second, char const *const op,
                     char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_double(int eval_result, char const *const expr, double first,
                      double second, char const *const op,
                      char const *const file_path, unsigned const line_num) {
  char expression[2048];
  cester_sprintf3(expression, 2048, expr, second, op, first);
  cester_evaluate_expression(eval_result, (char *)expression, file_path,
...
static __CESTER_INLINE__ void
cester_compare_ldouble(int eval_result, char const *const expr,
...
*/
#define CESTER_BEFORE_EACH(w, x, y, z)                                         \
...
*/
#define CESTER_AFTER_EACH(w, x, y, z)                                          \
...
#define CESTER_AFTER_EACH(w, x, y, ...)                                        \
  {CESTER_RESULT_UNKNOWN,                                                      \
   ...
   0.000,                                                                      \
   (char *)"",                                                                 \
   (char *)"cester_after_each_test",                                           \
   NULL,                                                                       \
   (cester_after_each_test),                                                   \
   NULL,                                                                       \
   CESTER_AFTER_EACH_TEST},
#define CESTER_OPTIONS(...)                                                    \
  {CESTER_RESULT_UNKNOWN,                                                      \
   __LINE__,                                                                   \
   CESTER_RESULT_SUCCESS,                                                      \
   0.000,                                                                      \
   0.000,                                                                      \
   (char *)"",                                                                 \
   (char *)"cester_options_before_main",                                       \
   NULL,                                                                       \
   NULL,                                                                       \
...
#define CESTER_COMMENT(...)                                                    \
  {CESTER_RESULT_UNKNOWN,                                                      \
   ...
   0.000,                                                                      \
   (char *)"",                                                                 \
   (char *)"cester_test_file_comment_function",                                \
   NULL,                                                                       \
   NULL,                                                                       \
...
#endif
#ifndef CESTER_NO_TIME
    {CESTER_RESULT_UNKNOWN, 0, CESTER_RESULT_SUCCESS, 0.000, 0.000, NULL, NULL,
     NULL, NULL, NULL, CESTER_TESTS_TERMINATOR}
#else
    {CESTER_RESULT_UNKNOWN, 0, CESTER_RESULT_SUCCESS, NULL, NULL, NULL, NULL,
     NULL, CESTER_TESTS_TERMINATOR}
#endif
};
#ifdef __cplusplus
extern "C" {
...
#ifdef __CESTER_STDC_VERSION__
#define CESTER_TEST(x, y, ...)                                                 \
  static void cester_test_##x(TestInstance *y) { __VA_ARGS__ }
#define CESTER_TODO_TEST(x, y, ...)                                            \
  static void cester_test_##x(TestInstance *y) { __VA_ARGS__ }
#define CESTER_SKIP_TEST(x, y, ...)                                            \
  static void cester_test_##x(TestInstance *y) { __VA_ARGS__ }
#define CESTER_BEFORE_ALL(x, ...)                                              \
  void cester_before_all_test(TestInstance *x) {                               \
    __VA_ARGS__ CESTER_NO_ISOLATION();                                         \
  }
#define CESTER_BEFORE_EACH(w, x, y, ...)                                       \
  void cester_before_each_test(TestInstance *w, char *const x, unsigned y) {   \
    __VA_ARGS__ CESTER_NO_ISOLATION();                                         \
...
#define CESTER_OPTIONS(...)                                                    \
  void cester_options_before_main() { __VA_ARGS__ }
#define CESTER_BODY(...) __VA_ARGS__
#define CESTER_COMMENT(...)                                                    \
  void cester_test_file_comment_function() {                                   \
    if (cester_string_equals(superTestInstance.output_format,                  \
                             (char *)"text") == 1) {                           \
      CESTER_DELEGATE_FPRINT_STR((default_color), "\n");                       \
      CESTER_DELEGATE_FPRINT_STR((default_color), #__VA_ARGS__);               \
      CESTER_DELEGATE_FPRINT_STR((default_color), "\n");                       \
    }                                                                          \
  }
#ifndef CESTER_NO_MOCK
#define CESTER_MOCK_SIMPLE_FUNCTION(x, y, ...)                                 \
  y __wrap_##x { return __VA_ARGS__; }
#define CESTER_MOCK_FUNCTION(x, y, ...)                                        \
  y __wrap_##x { __VA_ARGS__ }
#else
#define CESTER_MOCK_SIMPLE_FUNCTION(x, y, ...)
#define CESTER_MOCK_FUNCTION(x, y, ...)
#endif
...
#define CESTER_OPTIONS(x)                                                      \
  void cester_options_before_main() { x }
...
#define CESTER_COMMENT(x)                                                      \
  void cester_test_file_comment_function() {                                   \
    if (cester_string_equals(superTestInstance.output_format,                  \
                             (char *)"text") == 1) {                           \
      CESTER_DELEGATE_FPRINT_STR((default_color), "\n");                       \
      CESTER_DELEGATE_FPRINT_STR((default_color), #x);                         \
      CESTER_DELEGATE_FPRINT_STR((default_color), "\n");                       \
    }                                                                          \
  }
#ifndef CESTER_NO_MOCK
...
/**
    ...
    be executed.
*/
#define CESTER_REGISTER_TEST(x)                                                \
  cester_register_test((char *)#x, (cester_test_##x), NULL, NULL, __LINE__,    \
                       CESTER_NORMAL_TEST)
...
/**
    ...
    reason.
*/
#define CESTER_REGISTER_SKIP_TEST(x)                                           \
  cester_register_test((char *)#x, (cester_test_##x), NULL, NULL, __LINE__,    \
                       CESTER_NORMAL_SKIP_TEST)
...
*/
#define CESTER_REGISTER_TODO_TEST(x)                                           \
  cester_register_test((char *)#x, (cester_test_##x), NULL, NULL, __LINE__,    \
                       CESTER_NORMAL_TODO_TEST)
...
*/
#define CESTER_REGISTER_BEFORE_ALL()                                           \
  cester_register_test("cester_before_all_test", (cester_before_all_test),     \
                       NULL, NULL, __LINE__, CESTER_BEFORE_ALL_TEST)

/**
    Manually notify cester to execute the BEFORE_EACH function to execute
    every time before a test case is run.
*/
#define CESTER_REGISTER_BEFORE_EACH()                                          \
  cester_register_test("cester_before_each_test", NULL,                        \
                       (cester_before_each_test), NULL, __LINE__,              \
                       CESTER_BEFORE_EACH_TEST)
...
*/
#define CESTER_REGISTER_AFTER_ALL()                                            \
  cester_register_test("cester_after_all_test", (cester_after_all_test), NULL, \
                       NULL, __LINE__, CESTER_AFTER_ALL_TEST)

/**
    Manually notify cester to execute the AFTER_EACH function to execute
    every time after a test case is run.
*/
#define CESTER_REGISTER_AFTER_EACH()                                           \
  cester_register_test("cester_after_each_test", NULL,                         \
                       (cester_after_each_test), NULL, __LINE__,               \
                       CESTER_AFTER_EACH_TEST)
...
/**
    ...
    the tests.
*/
#define CESTER_REGISTER_OPTIONS()                                              \
  cester_register_test("cester_options_before_main", NULL, NULL,               \
                       (cester_options_before_main), __LINE__,                 \
                       CESTER_OPTIONS_FUNCTION)
...
/**
    ...
    the tests.
*/
#define CESTER_REGISTER_COMMENT()                                              \
  cester_register_test("cester_test_file_comment_function", NULL, NULL,        \
                       (cester_test_file_comment_function), __LINE__,          \
                       CESTER_OPTIONS_FUNCTION)
...
/**
    ...
    \param x the test case name
*/
#define CESTER_TEST_SHOULD_SEGFAULT(x)                                         \
  CESTER_TEST_SHOULD(x, CESTER_RESULT_SEGFAULT);
...
/**
    ...
    \param x the test case name
*/
#define CESTER_TEST_SHOULD_BE_TERMINATED(x)                                    \
  CESTER_TEST_SHOULD(x, CESTER_RESULT_TERMINATED);

#ifndef CESTER_NO_MEM_TEST
/**
    Change the expected test case result to leak memory. If the test case does
   not leak any memory then the test case is marked as failure.

    \param x the test case name
*/
#define CESTER_TEST_SHOULD_LEAK_MEMORY(x)                                      \
  CESTER_TEST_SHOULD(x, CESTER_RESULT_MEMORY_LEAK);
#endif
...
*/
static __CESTER_INLINE__ void
cester_register_test(char *test_name, cester_test f1,
                     cester_before_after_each f2, cester_void f3,
                     unsigned line_num, TestType test_type) {
  TestCase *test_case;
  if (superTestInstance.registered_test_cases == NULL) {
    if (cester_array_init(&superTestInstance.registered_test_cases) == 0) {
      ...
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                 "Unable to initialize the test cases array. "
                                 "Cannot run manually registered tests.\n");
      return;
    }
  }
  ...
  if (cester_array_add(superTestInstance.registered_test_cases, test_case) ==
      0) {
    if (superTestInstance.output_stream == NULL) {
      superTestInstance.output_stream = stdout;
    }
...
static __CESTER_INLINE__ void
cester_expected_test_result(const char *const test_name,
  ...
  if (superTestInstance.registered_test_cases->size == 0) {
    for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
      ...
      if ((cester_test_cases[i].test_type == CESTER_NORMAL_TEST ||
           cester_test_cases[i].test_type == CESTER_NORMAL_TODO_TEST ||
           cester_test_cases[i].test_type == CESTER_NORMAL_SKIP_TEST) &&
          cester_string_equals(cester_test_cases[i].name, (char *)test_name) ==
              1) {
  ...
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index, test_case, {
        if ((((TestCase *)test_case)->test_type == CESTER_NORMAL_TEST ||
             ((TestCase *)test_case)->test_type == CESTER_NORMAL_TODO_TEST ||
             ((TestCase *)test_case)->test_type == CESTER_NORMAL_SKIP_TEST) &&
            cester_string_equals(((TestCase *)test_case)->name,
                                 (char *)test_name) == 1) {
...
static __CESTER_INLINE__ unsigned
cester_run_test_no_isolation(TestInstance *, TestCase *, unsigned);

static __CESTER_INLINE__ void
cester_report_single_test_result(unsigned last_status, TestCase *a_test_case) {
#ifndef CESTER_NO_TIME
  clock_t tok;

  tok = clock();
  a_test_case->execution_time =
      (double)(((double)tok) - ((double)a_test_case->start_tic)) /
      CLOCKS_PER_SEC;
#endif
  if ((a_test_case->expected_result == last_status ||
       a_test_case->expected_result == CESTER_RESULT_FAILURE) &&
    ...
    cester_concat_str(&a_test_case->execution_output, "\n");
             ...
             a_test_case->expected_result != CESTER_RESULT_SUCCESS) {
...
static __CESTER_INLINE__ void cester_run_test(TestInstance *test_instance,
                                              TestCase *a_test_case,
                                              unsigned index) {
...
#ifndef __CESTER_STDC_VERSION__
#pragma message(                                                               \
    "Isolated tests not supported in C version less than C99 and C++ version less than C++11. cester will rely of signal for crash reporting")
  ...
  if (superTestInstance.isolate_tests == 1 &&
    ...
    snprintf(
        command, 1500,
        "%s --cester-test=%s  --cester-singleoutput --cester-noisolation %s %s "
        "%s %s %s %s %s",
        test_instance->argv[0], a_test_case->name,
        ...
        (superTestInstance.format_test_name == 0 ? "--cester-dontformatname"
                                                 : ""),
        (cester_string_equals(superTestInstance.output_format, (char *)"tap") ==
                 1
             ? "--cester-output=tap"
             : ""),
        (cester_string_equals(superTestInstance.output_format,
                              (char *)"tapV13") == 1
             ? "--cester-output=tapV13"
             : ""),
  ...
  end_sub_process:
    ...
    if (pid == -1) {
      CESTER_DELEGATE_FPRINT_STR(
          (CESTER_FOREGROUND_YELLOW),
          "Unable to create a seperate process for the '");
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW), a_test_case->name);
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                 "'. Running the test on main process.");
      last_status =
          cester_run_test_no_isolation(test_instance, a_test_case, index);
      ...
      execl(
          test_instance->argv[0], test_instance->argv[0], selected_test_unix,
          "--cester-singleoutput", "--cester-noisolation",
          (superTestInstance.mem_test_active == 0 ? "--cester-nomemtest" : ""),
          (superTestInstance.minimal == 1 ? "--cester-minimal" : ""),
          (superTestInstance.verbose == 1 ? "--cester-verbose" : ""),
          (superTestInstance.format_test_name == 0 ? "--cester-dontformatname"
          ...
          (cester_string_equals(superTestInstance.output_format,
               ...
               ? "--cester-output=tapV13"
               : ""),
          superTestInstance.flattened_cmd_argv, (char *)NULL);
...
#else
#pragma message(                                                               \
    "Isolated tests not supported in this environment. The tests will be run on the main process")
    last_status =
        cester_run_test_no_isolation(test_instance, a_test_case, index);
...
static __CESTER_INLINE__ unsigned
cester_run_test_no_isolation(TestInstance *test_instance, TestCase *a_test_case,
                             unsigned index) {
  unsigned i, index1, index2, mem_index, ret_val;
  char *prefix = "";
  superTestInstance.current_execution_status = CESTER_RESULT_SUCCESS;
  if (superTestInstance.registered_test_cases->size == 0) {
    for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
      ...
      if (cester_test_cases[i].test_type == CESTER_BEFORE_EACH_TEST) {
        superTestInstance.current_cester_function_type =
            CESTER_BEFORE_EACH_TEST;
        ((cester_before_after_each)cester_test_cases[i].test_ba_function)(
            test_instance, a_test_case->name, index);
      }
    }
  }
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index1, test_case, {
        if (((TestCase *)test_case)->test_type == CESTER_BEFORE_EACH_TEST) {
          superTestInstance.current_cester_function_type =
              CESTER_BEFORE_EACH_TEST;
          ((cester_before_after_each)((TestCase *)test_case)->test_ba_function)(
              test_instance, a_test_case->name, index);
        }
      })
  ...
  if (check_memory_allocated_for_functions(
          a_test_case->name, NULL, prefix,
          &(superTestInstance.current_test_case)->execution_output) > 0) {
    superTestInstance.current_execution_status = CESTER_RESULT_MEMORY_LEAK;
  }
  if (superTestInstance.registered_test_cases->size == 0) {
    for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
  ...
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index2, test_case, {
  ...
  if (superTestInstance.selected_test_cases_size == 0) {
    if (superTestInstance.registered_test_cases->size == 0) {
      for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
        ...
        if (cester_test_cases[i].test_type == CESTER_NORMAL_TEST &&
            cester_test_cases[i].execution_status == CESTER_RESULT_UNKNOWN) {
          cester_run_test(superTestInstance.test_instance,
                          &cester_test_cases[i], ++test_index);
        ...
        superTestInstance.registered_test_cases, index2, test_case, {
          if (((TestCase *)test_case)->test_type == CESTER_NORMAL_TEST &&
              ((TestCase *)test_case)->execution_status ==
                  CESTER_RESULT_UNKNOWN) {
            cester_run_test(superTestInstance.test_instance,
                            ((TestCase *)test_case), ++test_index);

          } else if (((TestCase *)test_case)->test_type ==
                     CESTER_NORMAL_TODO_TEST) {
            ++superTestInstance.todo_tests_count;
    ...
    for (j = superTestInstance.selected_test_cases_found;
         j < superTestInstance.selected_test_cases_size; ++j) {
      ...
      if (superTestInstance.registered_test_cases->size == 0) {
        for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
          ...
          if ((cester_test_cases[i].test_type == CESTER_NORMAL_TEST ||
               cester_test_cases[i].test_type == CESTER_NORMAL_TODO_TEST ||
               cester_test_cases[i].test_type == CESTER_NORMAL_SKIP_TEST) &&
              cester_string_equals(cester_test_cases[i].name,
                                   selected_test_case_name) == 1 &&
              cester_test_cases[i].execution_status == CESTER_RESULT_UNKNOWN) {
      ...
      if (found_test == 0) {
        CESTER_ARRAY_FOREACH(
            superTestInstance.registered_test_cases, index3, test_case, {
              if ((((TestCase *)test_case)->test_type == CESTER_NORMAL_TEST ||
                   ((TestCase *)test_case)->test_type ==
                       CESTER_NORMAL_TODO_TEST ||
                   ((TestCase *)test_case)->test_type ==
                       CESTER_NORMAL_SKIP_TEST) &&
                  cester_string_equals(((TestCase *)test_case)->name,
                ...
                if (((TestCase *)test_case)->test_type == CESTER_NORMAL_TEST) {
                  ...
                  ((TestCase *)test_case)->execution_status =
                      CESTER_RESULT_SUCCESS;
                  if (((TestCase *)test_case)->test_type ==
                      CESTER_NORMAL_SKIP_TEST) {
                    ++superTestInstance.skipped_test_count;
                  } else {
                    ++superTestInstance.todo_tests_count;
        ...
        if (found_test == 0) {
          if (superTestInstance.minimal == 0 &&
            ...
            CESTER_DELEGATE_FPRINT_STR(
                (CESTER_FOREGROUND_YELLOW),
                superTestInstance.selected_test_cases_names[j]);
            CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                       "' was not found! \n");
          }
        }
...
static __CESTER_INLINE__ unsigned cester_run_all_test(unsigned argc,
                                                      char **argv) {
  char *cester_option;
  char *arg;
  ...
  if (superTestInstance.mem_alloc_manager == NULL) {
    if (cester_array_init(&superTestInstance.mem_alloc_manager) == 0) {
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                 "Unable to initialize the memory management "
                                 "array. Memory test disabled.\n");
      superTestInstance.mem_test_active = 0;
    }
  }
#endif
  if (superTestInstance.registered_test_cases == NULL) {
    if (cester_array_init(&superTestInstance.registered_test_cases) == 0) {
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_RED),
                                 "Unable to initialize the registered test "
                                 "cases array. Cannot continue tests.\n");
      return CESTER_RESULT_FAILURE;
    }
  }
  ...
  for (; j < argc; ++j) {
    arg = argv[j];
    if (cester_str_after_prefix(arg, (char *)"--cester-", 9, &cester_option) ==
        1) {
      ...
      } else if (cester_string_equals(cester_option, (char *)"printversion") ==
                 1) {
        superTestInstance.print_version = 1;

      } else if (cester_string_equals(cester_option, (char *)"singleoutput") ==
                 1) {
        superTestInstance.single_output_only = 1;

      } else if (cester_string_equals(cester_option, (char *)"noisolation") ==
                 1) {
        superTestInstance.isolate_tests = 0;

      } else if (cester_string_equals(cester_option,
                                      (char *)"dontformatname") == 1) {
        superTestInstance.format_test_name = 0;
#ifndef CESTER_NO_MEM_TEST
      } else if (cester_string_equals(cester_option, (char *)"nomemtest") ==
                 1) {
        superTestInstance.mem_test_active = 0;
#endif
      ...
      } else if (cester_string_starts_with(cester_option, (char *)"test=") ==
                 1) {
        unpack_selected_extra_args(cester_option,
                                   &superTestInstance.selected_test_cases_names,
                                   &superTestInstance.selected_test_cases_size);

      } else if (cester_string_starts_with(cester_option, (char *)"output=") ==
                 1) {
        cester_str_value_after_first(cester_option, '=',
                                     &superTestInstance.output_format);
        if (cester_is_validate_output_option(superTestInstance.output_format) ==
            0) {
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_RED),
                                     "Invalid cester output format: ");
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_RED),
                                     superTestInstance.output_format);
          CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_RED), "\n");
          if (cester_string_starts_with(superTestInstance.output_format,
                                        (char *)"tap")) {
            CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                       "Did you mean 'tap' or 'tapV13?'\n");
          }
          CESTER_RESET_TERMINAL_ATTR()
          return EXIT_FAILURE;
        }
  ...
  superTestInstance.test_instance =
      (TestInstance *)malloc(sizeof(TestInstance));
  ...
  for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR; ++i) {
    if ((cester_test_cases[i].test_type == CESTER_OPTIONS_FUNCTION ||
         cester_test_cases[i].test_type == CESTER_TEST_FILE_COMMENT) &&
        superTestInstance.single_output_only == 0) {
  ...
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index, test_case, {
        if ((((TestCase *)test_case)->test_type == CESTER_OPTIONS_FUNCTION ||
             ((TestCase *)test_case)->test_type == CESTER_TEST_FILE_COMMENT) &&
            superTestInstance.single_output_only == 0) {
          superTestInstance.current_cester_function_type =
              CESTER_OPTIONS_FUNCTION;
  ...
  if (superTestInstance.registered_test_cases->size == 0) {
    for (i = 0; cester_test_cases[i].test_type != CESTER_TESTS_TERMINATOR;
      ...
      if (cester_test_cases[i].test_type == CESTER_BEFORE_ALL_TEST &&
        ...
        ((cester_test)cester_test_cases[i].test_function)(
            superTestInstance.test_instance);
      }
    }
  }
  CESTER_ARRAY_FOREACH(
      superTestInstance.registered_test_cases, index1, test_case, {
        if (((TestCase *)test_case)->test_type == CESTER_BEFORE_ALL_TEST &&
          ...
          superTestInstance.current_cester_function_type =
              CESTER_BEFORE_ALL_TEST;
          ((cester_test)((TestCase *)test_case)->test_function)(
              superTestInstance.test_instance);
        }
      })
  ...
  return cester_print_result(cester_test_cases,
                             superTestInstance.test_instance);
}

#ifndef CESTER_NO_MAIN
int main(int argc, char **argv) { return CESTER_RUN_ALL_TESTS(argc, argv); }
#endif
...
void cester_recover_on_signal(int sig_num) {
  ...
  case SIGINT: /* this is one crazy kill signal */
    ...
    cester_report_single_test_result(superTestInstance.current_execution_status,
                                     superTestInstance.current_test_case);
    cester_run_all_test_iterator(0);
    exit(cester_print_result(cester_test_cases,
                             superTestInstance.test_instance));
    break;
  case SIGFPE:
  case SIGTERM:
...
static __CESTER_INLINE__ unsigned cester_array_add(CesterArray *array,
                                                   void *item) {
  void **new_buffer;
  if (array->size >= array->capacity) {
    if (array->capacity >= CESTER_ARRAY_MAX_CAPACITY) {
      CESTER_DELEGATE_FPRINT_STR(
          (CESTER_FOREGROUND_YELLOW),
          "Max managable memory allocation reached, cannot expand array. "
          "Further Memory test disabled.\n");
      superTestInstance.mem_test_active = 0;
      return 0;
    }
    ...
    if (!new_buffer) {
      CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                 "Failed to expand the memory allocation "
                                 "array. Further Memory test disabled.\n");
      superTestInstance.mem_test_active = 0;
      return 0;
    }
...
static __CESTER_INLINE__ void *cester_array_remove_at(CesterArray *array,
                                                      unsigned index) {
  void *item = array->buffer[index];
  if (index != array->size - 1) {
    unsigned block_size = (array->size - 1 - index) * sizeof(void *);
    memmove(&(array->buffer[index]), &(array->buffer[index + 1]), block_size);
  }
  return item;
}
...
static __CESTER_INLINE__ void *cester_malloc(unsigned size, const char *file,
  ...
  actual_function_name = func;
#endif
  if (superTestInstance.current_cester_function_type ==
      CESTER_BEFORE_ALL_TEST) {
  ...
  p = malloc(size);
  if (superTestInstance.mem_test_active == 1) {
    AllocatedMemory *allocated_mem =
        (AllocatedMemory *)malloc(sizeof(AllocatedMemory));
    allocated_mem->line_num = line;
    allocated_mem->allocated_bytes = size;
    if (cester_str_after_prefix(actual_function_name, (char *)"cester_test_",
                                12, (char **)&(allocated_mem->function_name)) ==
        0) {
      allocated_mem->function_name = actual_function_name;
    }
    allocated_mem->file_name = file;
    cester_ptr_to_str(&allocated_mem->address, p);
    if (cester_array_add(superTestInstance.mem_alloc_manager, allocated_mem) ==
        0) {
      CESTER_DELEGATE_FPRINT_STR(
          (CESTER_FOREGROUND_YELLOW),
          "Failed to register allocated memory. Memory test disabled.\n");
      superTestInstance.mem_test_active = 0;
    }
  }
  return p;
...
static __CESTER_INLINE__ void cester_free(void *pointer, const char *file,
                                          unsigned line, const char *func) {
  unsigned index;
  if (pointer == NULL) {
    if (superTestInstance.mem_test_active == 1 &&
        superTestInstance.current_test_case != NULL) {
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output,
          "InvalidOperation ");
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output,
          (superTestInstance.minimal == 0
      ...
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output, ":");
      cester_concat_int(
          &(superTestInstance.current_test_case)->execution_output, line);
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output, ": ");
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output, "in '");
      cester_concat_str(
          &(superTestInstance.current_test_case)->execution_output,
          (superTestInstance.current_test_case)->name);
      cester_concat_str(
  ...
  if (superTestInstance.mem_test_active == 1) {
    ...
    CESTER_ARRAY_FOREACH(
        superTestInstance.mem_alloc_manager, index, alloc_mem, {
          if (cester_string_equals(((AllocatedMemory *)alloc_mem)->address,
                                   address) == 1) {
            if (!cester_array_remove_at(superTestInstance.mem_alloc_manager,
                                        index)) {
              CESTER_DELEGATE_FPRINT_STR((CESTER_FOREGROUND_YELLOW),
                                         "Memory allocation array corrupted. "
                                         "Further Memory test disabled.\n");
              superTestInstance.mem_test_active = 0;
            }
            free(alloc_mem);
...
#define malloc(x)                                                              \
  cester_malloc(                                                               \
      x, __FILE__, __LINE__,                                                   \
      __FUNCTION__) /**< Override the default malloc function for mem test */
#define free(x)                                                                \
  cester_free(                                                                 \
      x, __FILE__, __LINE__,                                                   \
      __FUNCTION__) /**< Override the default free function for mem test   */
#endif
